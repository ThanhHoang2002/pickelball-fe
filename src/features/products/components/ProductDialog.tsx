...
const ProductDialog = ({
  ...
  // State for zero price confirmation dialog
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Check if price is zero and show confirmation dialog
    if (formData.sellPrice === 0) {
      setPendingFormData(prepareFormData());
      setShowZeroPriceAlert(true);
      return;
    }
    
    // If price is not zero, proceed with form submission
...
**Bold text** for emphasis"
      ...
      <AlertDialog open={showZeroPriceAlert} onOpenChange={setShowZeroPriceAlert}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Set Price to Zero?</AlertDialogTitle>
            <AlertDialogDescription>
              You are about to set the product price to $0. This means the product will be free.
              Are you sure you want to continue?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel onClick={handleZeroPriceCancel}>
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction onClick={handleZeroPriceConfirm}>
              Yes, set price to $0
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
